package com.hevelian.identity.web.content;
...
//	private Configuration config = new Configuration();
	...
	@Autowired
	public Template(SessionStore sessionStore) {
		this.sessionStore = sessionStore;
	}
	
	public Template(FileReader file) {
		try {
	...
	public Template(String buffer) {
		try {
			dbFactory = DocumentBuilderFactory.newInstance();
			dBuilder = dbFactory.newDocumentBuilder();

		    document = dBuilder.parse(buffer);
